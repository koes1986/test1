...
#elif (FFT_N ==  32)
  #include <wklookup_16.inc> //editted in here
#elif (FFT_N ==  16)
  #include <wklookup_16.inc>
#endif
};

extern const int16_t __attribute__((used)) _wk_constants512[] PROGMEM = {
	#include <wklookup_512.inc>
};


#if (REORDER == 1)
  extern const uint16_t __attribute__((used)) _reorder_table[] PROGMEM = {
  #if (FFT_N == 256)
    #include <256_reorder.inc>
  #elif (FFT_N == 512)
    #include <512_reorder.inc>
  #elif (FFT_N == 128)
  ...
  extern const int16_t __attribute__((used)) _window1_func[] PROGMEM = {
  #if (FFT_N ==  256)
    #include <hann_256.inc>
  #elif (FFT_N ==  128)
    #include <hann_128.inc>
  #elif (FFT_N ==  512)
    #include <hann_256_1.inc>
  #elif (FFT_N ==  64)
    #include <hann_64.inc>
  #elif (FFT_N ==  32)
    #include <hann_32.inc>
...
#endif
	extern const int16_t __attribute__((used)) _window2_func[] PROGMEM = {
		#include <hann_256_2.inc> 
	};

int __attribute__((used)) fft_input[(FFT_N*2)]; // fft input data buffer
int __attribute__((used)) fft_input2[(FFT_N)];
int __attribute__((used)) fft_input3[(FFT_N)];
...
static inline void fft_run(void) {
  ...
  "ldi r16, " STRINGIFY(FFT_N2/2) " \n" // prep loop counter
  "ldi r28, lo8(fft_input2) \n" //set to beginning of data space
  "ldi r29, hi8(fft_input2) \n"
  ...
  "mov r12,r16 \n"
  "clr r13 \n"
  "ldi r16, hi8((fft_input2 + " STRINGIFY(FFT_N2*4) ")) \n" // prep end of dataspace register
  "mov r10, r16 \n"
  ...
  "5: \n"
  "ldi r26, lo8(fft_input2) \n" //set top pointer to beginning of data space
  "ldi r27, hi8(fft_input2) \n"
  ...
  asm volatile (
  "9: \n"
  "cpi r28, lo8(fft_input2 + " STRINGIFY(FFT_N2*4) ") \n" // check if at end of dataspace
  "cpc r29, r10 \n"
  "brsh 10f \n"
  "movw r26,r28 \n" // bottom is now top
...
static inline void fft_window1(void) {
  // store registers so they dont get clobbered
  // avr-gcc requires r2:r17,r28:r29, and r1 cleared
  asm volatile (
  "push r2 \n"
  ...
  "ldi r30, lo8(_window1_func) \n" // set to beginning of lookup table
  "ldi r31, hi8(_window1_func) \n"
  "clr r15 \n" // prep null register
  "ldi r20, " STRINGIFY(((FFT_N2)&(0xff))) " \n"
  //"ldi r24, 0 \n"
  //"ldi r25, 1\n"
  ...
  "brne 1b \n"
  : :
  : "r0", "r30", "r31", "r22", "r23","r20" // clobber list
  );
...
static inline void fft_window2(void) {
  // store registers so they dont get clobbered
  // avr-gcc requires r2:r17,r28:r29, and r1 cleared
  asm volatile (
  "push r2 \n"
  ...
  "ldi r28, lo8(fft_input2) \n" // set to beginning of data space
  "ldi r29, hi8(fft_input2) \n"
  "ldi r30, lo8(_window2_func) \n" // set to beginning of lookup table
  "ldi r31, hi8(_window2_func) \n"
  "clr r15 \n" // prep null register
  "ldi r20, " STRINGIFY(((FFT_N2)&(0xff))) " \n"
  //"ldi r20, 255 \n"
  //"ldi r25, 0\n"
